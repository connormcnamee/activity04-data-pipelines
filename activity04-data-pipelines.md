...
**Response**: Sort the data set by the unemployment rate ascending.
...
**Response**: The major with the highest share of women is Early
childhood education.
...
**Response**: There are 10 stem majors that earn less than the median
salary.
